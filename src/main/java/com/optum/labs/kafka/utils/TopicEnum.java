...
public enum TopicEnum {
    CREDIT_LINE_DETAILS_TOPIC("credit.creditlines.creditline-detials.in"),
    CREDIT_LINE_DETAILS_TOPIC_OUTPUT("credit.creditlines.creditline-details.out"),
    ...
    PRODUCT_CATEGORY_DETAILS_TOPIC("credit.creditlines.product-category-product-code.out"),
    CURRENCY_CODE_TOPIC("credit.creditlines.currency-code.in"),
    LOAN_TXN_TOPIC("credit.creditlines.loantxn.activity.in"),
    ...
    CLIENT_DETAILS_TOPIC("credit.creditlines.ulf-client-detials.in"),
    CREDIT_LINE_TOPIC_15("credit.creditlines.flex-creditline-and-activity-and-loantxn-and-prodcat.out"),
    FLEX_CREDITLINE_TOPIC_INPUT("credit.creditlines.flex-creditline.in");
